 ...
 */
export const DEFAULT_CONFIG_FILE_NAME = 'ianaio.config';

/** Can be absolute or relative to site directory. */
export const BABEL_CONFIG_FILE_NAME =
  process.env.IANAIO_BABEL_CONFIG_FILE_NAME ?? 'babel.config.js';
...
export const GENERATED_FILES_DIR_NAME =
  process.env.IANAIO_GENERATED_FILES_DIR_NAME ?? '.ianaio';
